# @TranNhiem 2022/06/19 
## The model weights inherence from Opensource Community 
    ...
    if os.path.isfile(download_target): 
        if expected_sha256: 
            if hashlib.sha256(open(download_target, "rb").read()).hexdigest() ==expected_sha256: 
                ...
                warnings.warn(f"{download_target}, but the SHA256 checksum does not match; re-downloading the file")
        else: 
            return download_target 
